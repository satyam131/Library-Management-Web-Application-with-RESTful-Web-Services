...
public class BookService {
	...
	public List<Book> retrieveBooks() {
		...
		try {
			URL url = new URL("http://localhost:8089/App2Assignment5/book");
	...
	public void deleteBook(int bookcode) {
		...
		try {
			URL url = new URL("http://localhost:8089/App2Assignment5/book/" +bookcode);
			// Parse URL into HttpURLConnection in order to open the connection in order to
			// get the JSON data
			HttpURLConnection conn = (HttpURLConnection) url.openConnection();
			// Set the request to GET or POST as per the requirements
	...
	public void saveBook(Book book,String method) {
		...
		String query_url = "http://localhost:8089/App2Assignment5/book";
